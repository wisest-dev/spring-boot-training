...
@ControllerAdvice
class EnrollmentNotFoundAdvice {

	@ResponseBody
	@ExceptionHandler(EnrollmentNotFoundException.class)
	@ResponseStatus(HttpStatus.NOT_FOUND)
	String enrollmentNotFoundHandler(EnrollmentNotFoundException ex) {
		return "enrollmentNotFoundHandler is here to tell you that: " + ex.getMessage();
	}
